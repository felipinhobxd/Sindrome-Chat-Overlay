...
from ..sounds import NotificationSoundPlayer
from ..updates import (
    UpdateChecker,
    UpdateCheckResult,
    UpdateDownloader,
...
class OverlayWindow(QMainWindow):
    def __init__(
        ...
        self.store = store
        self.log = logger
        self.notification_sounds = NotificationSoundPlayer(
            logger,
    ...
    def _play_message_sound(self, platform: str) -> None:
        self.notification_sounds.play(
            ...
            twitch_sound=self.settings.twitch_sound,
            youtube_sound=self.settings.youtube_sound,
